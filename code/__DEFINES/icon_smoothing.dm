...
// Troutstation edit
#define SMOOTH_GROUP_FLOCK S_TURF(70) ///turf/open/floor/flock
#define SMOOTH_GROUP_CARPET_PICNIC S_TURF(71) ///turf/open/floor/carpet/picnic
#define SMOOTH_GROUP_FLOCK_OUTPOST S_TURF(72) ///turf/open/floor/flock_outpost
#define SMOOTH_GROUP_CARPET_FLOCK_OUTPOST S_TURF(73) ///turf/open/floor/flock_outpost/carpet
#define SMOOTH_GROUP_FLOCK_OUTPOST_LIGHT S_TURF(74) ///turf/open/floor/flock_outpost/light
