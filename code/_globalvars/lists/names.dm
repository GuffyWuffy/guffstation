...
GLOBAL_LIST_INIT(anteater_first, world.file2list("strings/names/anteater_first.txt"))
GLOBAL_LIST_INIT(anteater_last, world.file2list("strings/names/anteater_last.txt"))
